...
function Menu.Draw()
  ...
  if Menu.menuState == "title" then
    ...
    love.graphics.printf("HOLY BLACK", 0, anchorTitleY, windowWidth, "center")
    
    love.graphics.setColor(255, 0, 255)
    love.graphics.setFont(itemFonts.subTitles)
    love.graphics.printf("De Space Jam", 0, anchorTitleY + sizeFonts.titles, windowWidth, "center")
    
    love.graphics.setColor(0, 128, 0)
    love.graphics.setFont(itemFonts.version)
    love.graphics.printf("Theme : More Than One Dimension", 0, anchorTitleY + 2.5 * sizeFonts.titles, windowWidth, "center")
