...
function WindowDimension.Load()
  NewGameWindowWidth = ListResolution[1][1]
  NewGameWindowHeight = ListResolution[1][2]
  ...
  love.window.setMode(NewGameWindowWidth, NewGameWindowHeight, {fullscreen=IsFullScreen, centered=true})
